...
### Решение.
Ниже представлен [скрипт](prac1/prac1_4.sh). пример кода [тут](prac1/main.c).
```
#!/bin/bash
...
### Решение.
Ниже скрипт, его также можно посмотреть [тут]()
```
#!/bin/bash
...
### Решение.
Скрипт ниже и [тут](prac1/prac1_6.sh). Программы на [.c](prac1/prac1_6.c), [.py](prac1/prac1_6.py) и [.js](prac1/prac1_6.js)
```
#!/bin/bash
...
### Решение.
Скрипт ниже и [тут](prac1/prac1_7.sh).
```
#!/bin/bash
...
### Решение.
Скрипт ниже и [тут](prac1/prac1_8.sh).
```
#!/bin/bash
...
### Решение.
Скрипт ниже и [тут](prac1/prac1_9.sh).
```
#!/bin/bash
...
### Решение.
Скрипт ниже и [тут](prac1/prac1_10.sh).
```
#!/bin/bash
